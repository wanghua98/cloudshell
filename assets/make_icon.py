# -*- coding: utf-8 -*-
"""Generate the cloudshell app icon (braised pork-belly + terminal prompt).

Pure-Pillow, 4x supersampled for crisp anti-aliasing.
Outputs:  icon.png (256), icon@512.png, cloudshell.ico (multi-size)
"""
import math
...
img256.save("cloudshell.ico", format="ICO",
            sizes=[(256, 256), (128, 128), (64, 64),
                   (48, 48), (32, 32), (16, 16)])
print("OK: icon.png, icon@512.png, cloudshell.ico written")
